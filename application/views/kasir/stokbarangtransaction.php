...
<table class="table table-bordered" width="100%">
    <tr>
        ...
        <td width="5%"><button type="button" id="btn-delete-transaction" class="btn btn-xs btn-danger" onclick="deletedtransaction('<?php echo $_GET['nofak'] ?>')"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
    </tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Pembayaran Transaksi Penjualan #<?php echo $_GET['nofak'] ?></h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="paymenttransaction('<?php echo $_GET['nofak'] ?>')">Bayar</button>
